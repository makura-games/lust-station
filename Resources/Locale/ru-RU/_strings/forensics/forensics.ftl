...
forensics-verb-text = Счистить улики и запахи
forensics-verb-message = Счистить отпечатки пальцев, остатки ДНК и запахи!
forensics-cleaning = Вы начинаете счищать улики и запахи с { $target }...
