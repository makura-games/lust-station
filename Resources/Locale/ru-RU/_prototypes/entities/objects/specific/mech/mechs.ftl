...
ent-MechVim = вим
    .desc = Миниатюрный экзокостюм компании Нанотрейзен, разработанный для того, чтобы позволить незаменимым питомцам станции прожить немного дольше.
...
ent-MechGygaxSyndie = тёмный Гигакс
    .desc = Модифицированный Гигакс, используемый в неблаговидных целях. На задней стороне бронепластины имеется надпись «Киберсан Инк.».
...
ent-MechMaulerSyndie = маулер
    .desc = Модифицированный Мародёр, используемый Синдикатом, не такой маневренный, как тёмный Гигакс, но он компенсирует это броней и мощной огневой мощью. На задней стороне бронепластины имеется надпись «Киберсан Инк.».
