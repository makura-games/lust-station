...
smell-strength-medium = Ощутимы: {$notes}.
...
scent-vulp-base-warm-fur = тёплая шерсть
scent-vulp-base-groomed-fur = гладкий ухоженный мех
scent-vulp-base-rain-fur = влажная после дождя шерсть

scent-vulp-nature-pine = хвоя
scent-vulp-nature-herbs = сухие травы
scent-vulp-nature-honey = мёд
scent-vulp-nature-earth = мокрая земля

scent-vulp-accent-ozone = озон
scent-vulp-accent-wood = старая древесина
scent-vulp-accent-frost = морозный воздух
scent-vulp-accent-smoke = лёгкий дымок
